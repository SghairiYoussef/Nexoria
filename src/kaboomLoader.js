...
const loadPlayerSprites = () => {
  const sprites = [
    { name: "playerIdle", path: "./assets/Player/Idle.png", sliceX: 6, anims: { idle: { from: 0, to: 5 } } },
    { name: "playerRun", path: "./assets/Player/Run.png", sliceX: 8, anims: { run: { from: 0, to: 7 } } },
    ...
    { name: "playerWalk", path: "./assets/Player/Walk.png", sliceX: 8, anims: { walk: { from: 0, to: 7 } } },
